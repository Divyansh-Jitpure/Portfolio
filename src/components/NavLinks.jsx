  ...
  return (
    <a className="group flex items-center py-3" href={props.goto}>
      <span
        className={
          !props.active
            ? "mr-4 h-px w-8 bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200  motion-reduce:transition-none"
            : "mr-4 h-px w-16 bg-slate-200 transition-all group-hover:w-16 group-hover:bg-slate-200  motion-reduce:transition-none"
        }
      ></span>
      ...
      <span
        className={
          !props.active
            ? "font-bold uppercase tracking-widest text-slate-500 group-hover:text-cyan-400 "
            : "font-bold uppercase tracking-widest text-cyan-500 group-hover:text-cyan-400 "
        }
      >
